...
// source-hash: 77a6621e1b4eec2e84b9d9ac63d918c86daec810
let wasm;
...
const QrContainerFinalization = new FinalizationRegistry((ptr) =>
  wasm.__wbg_qrcontainer_free(ptr)
);
/** */
export class QrContainer {
  static __wrap(ptr) {
    const obj = Object.create(QrContainer.prototype);
    obj.ptr = ptr;
    QrContainerFinalization.register(obj, obj.ptr, obj);
    return obj;
  }
  ...
  __destroy_into_raw() {
    const ptr = this.ptr;
    this.ptr = 0;
    QrContainerFinalization.unregister(this);
    return ptr;
  }
   ...
   */
  get size() {
    const ret = wasm.__wbg_get_qrcontainer_size(this.ptr);
    return ret;
  }
  /**
   * @param {number} arg0
   */
  set size(arg0) {
    wasm.__wbg_set_qrcontainer_size(this.ptr, arg0);
  }
  /**
   * @param {string} s
   * @returns {QrContainer}
  ...
  static new(s) {
    ...
    const ret = wasm.qrcontainer_new(ptr0, len0);
    return QrContainer.__wrap(ret);
  }
  /**
   * @returns {Uint8Array}
   */
  read() {
    const ret = wasm.qrcontainer_read(this.ptr);
 ...
 *   exports: { add: typeof add; QrContainer : typeof QrContainer  }
 * }>}
 */
